...
const ImageComponent = ({
  ...
  return createElement(View, {
  ...
  }, Platform.isAndroid && createElement(Fragment, null, networkImageLoaded && networkURL && createElement(Animated.Image, {
    style: imageStyles,
    fadeDuration: 0,
    source: {
      uri: networkURL
  ...
  }), !networkImageLoaded && !networkURL && createElement(Animated.Image, {
    style: imageStyles,
    fadeDuration: 0,
    source: {
      uri: localURL
    ...
    resizeMode: imageResizeMode
  })), Platform.isIOS && createElement(Fragment, null, createElement(Animated.Image, {
    style: imageStyles,
    source: {
